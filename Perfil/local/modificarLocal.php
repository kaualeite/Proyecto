                ...
                <nav id="top" class="navbar navbar-inverse">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="../../homepage/Local/hplocal1.php">JavaDHuttMusic</a>
                        </div>
                ...
                <div id="caja2">
                    ...
                    <form  action="" method="post">
                        <fieldset >
                            ...
                            <label for="mail">Aforo:</label>
                            <input type="number" id="mail" name="aforo" value="<?php echo $aforo; ?>">

                            <label for="mail">Dirección:</label>
                            <input type="text" id="mail" name="direccion" value="<?php echo $direccion; ?>">
                            ...
                            <label>Sexo:</label>
                            <p>
                                <input type="radio"  value="D" name="sexo"><label for="Mujer" class="light">Mujer</label><br>
                    ...
                    if (isset($_POST["Modificar"])) {
                        ...
                        if ($nuevaP == $conf) {
                            ...
                            ModificarLocal($idusuario, $nombreu, $nombre, $apellido, $nuevaP, $ciudad, $mail, $tel, $nacimiento, $sexo, $aforo, $direc, $artistico);
                        } else {
                            ?>
