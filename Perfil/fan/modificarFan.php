                ...
                <nav id="top" class="navbar navbar-inverse">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="../../homepage/Fan/hpfan1.php">JavaDHuttMusic</a>
                        </div>
                ...
                <div id="caja2">
                    ...
                    <form action = "" method = "post">
                        <fieldset >
                            ...
                            <select name="ciudad" id = "name" value="<?php echo $ciudad; ?>">
                                <?php
                                $ciudad = selectCiudad();
                            ...
                            <label for = "mail">Nacimiento:</label>
                            <input type = "date" id = "mail" name = "fecha" placeholder = "AAAA-MM-DD" value="<?php echo $nacimiento; ?>">

                            <label>Sexo:</label>
                            <p>
                                <input type = "radio" value = "H" name = "sexo"><label for = "Mujer" class = "light">Mujer</label>
                                <input type = "radio" value = "D" name = "sexo"><label for = "Hombre" class = "light">Hombre</label>
                            </p>
                    ...
                    if (isset($_POST["Modificar"])) {
                        ...
                        if ($nuevaP == $conf) {
                            ...
                            ModificarFan($idusuario, $nombreu, $nombre, $apellido, $nuevaP, $ciudad, $mail, $tel, $nacimiento, $sexo);
                        } else {
                            ?>
